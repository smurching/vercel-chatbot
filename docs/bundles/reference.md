...
- - `database_catalogs`
  - Map
  - The database catalog definitions for the bundle, where each key is the name of the database catalog. See [\_](/dev-tools/bundles/resources.md#database_catalogs).
- - `experiments`
  - Map
...
### <a id="targetsnamebundle"></a>targets._name_.bundle
